...
class EvidenceAnalyzer:
    ...
    def analyze_evidence_sources(
        ...
        system_prompt = (
            ...
            "   - SUPPORT: The text affirms or confirms the core event, announcement, or primary action in the claim (even if minor secondary details or dates are missing or unspecified). If a newsroom reports that the main event happened, mark as SUPPORT.\n"
            "   - CONTRADICT: The text directly refutes, disputes, denies, or fact-checks the claim as false or fabricated.\n"
            "   - NEUTRAL: The text discusses an unrelated or tangential topic (e.g. a different court case, a different strike, or another topic) and neither confirms nor denies the central action.\n"
